...
public class UpdateStudent extends JFrame implements ActionListener{
    ...
    UpdateStudent() {
        ...
        try {
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select * from detail");
            while(rs.next()) {
        ...
        try {
            Conn c = new Conn();
            String query = "select * from detail where rollno='"+crollno.getSelectedItem()+"'";
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "update detail set address='"+address+"', phone='"+phone+"', email='"+email+"', course='"+course+"', branch='"+branch+"' where rollno='"+rollno+"'";
                Conn con = new Conn();
